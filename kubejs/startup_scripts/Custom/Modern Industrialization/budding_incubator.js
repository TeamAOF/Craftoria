...
MIMachineEvents.registerRecipeTypes(event => {
    BUDDING_INCUBATOR = event.register("budding_incubator")
        .withFluidInputs()
        .withItemOutputs();
});
...
MIMachineEvents.registerMachines(event => {
    ...
    const buddingIncubatorShape = event.layeredShape('sky_stone_brick_casing', [
        ['HHH', 'BAB', 'GGG'],
        ['HHH', 'A A', 'GGG'],
        ['H#H', 'BAB', 'GGG']
    ])
    ...
    event.simpleElectricCraftingMultiBlock(
        "Budding Incubator", "budding_incubator", BUDDING_INCUBATOR, buddingIncubatorShape,
        event.progressBar(77, 33, "arrow"),
        itemInputs => {},
        itemOutputs => itemOutputs.addSlots(102, 35, 1, 4),
        fluidInputs => fluidInputs.addSlots(56, 35, 1, 2),
        fluidOutputs => {},
        "sky_stone_brick_casing", "budding_incubator", true, false, false,
    );
});