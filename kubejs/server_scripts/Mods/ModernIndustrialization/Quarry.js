...
ServerEvents.recipes(event => {
  ...
  // Steel Drill
  MIQuarry(
    ['modern_industrialization:steel_drill', 1, 0.04],
    [
  ...
  // Gold Drill
  MIQuarry(
    ['modern_industrialization:gold_drill', 1, 0.1],
    [
  ...
  // Bronze Drill
  MIQuarry(
    ['modern_industrialization:bronze_drill', 1, 0.04],
    [
  ...
  // Titanium Drill
  MIQuarry(
    ['modern_industrialization:titanium_drill', 1, 0.04],
    [
  ...
  MIQuarry(
    ['modern_industrialization:stainless_steel_drill', 1, 0.04],
    [
