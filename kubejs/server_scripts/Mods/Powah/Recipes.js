ServerEvents.recipes(e => {
  ...
  e.shaped('powah:reactor_basic', ['ABA', 'BCB', 'ABA'], {
    A: 'powah:uraninite',
  ...
  e.shaped('powah:reactor_hardened', ['ABA', 'BCB', 'ABA'], {
    A: 'powah:uraninite',
  ...
  e.shaped('powah:reactor_blazing', ['ABA', 'BCB', 'ABA'], {
    A: 'powah:uraninite',
  ...
  e.shaped('powah:reactor_niotic', ['ABA', 'BCB', 'ABA'], {
    A: 'powah:uraninite',
  ...
  e.shaped('powah:reactor_spirited', ['ABA', 'BCB', 'ABA'], {
    A: 'powah:uraninite',
  ...
  e.shaped('powah:reactor_nitro', ['ABA', 'BCB', 'ABA'], {
    A: 'powah:uraninite',
