ServerEvents.recipes(event => {
  ...
  exCutter(event, "1x appflux:charged_redstone_block", "9x appflux:printed_energy_processor");
  ...
  //AE2 compat
  mekCrush('ae2:ender_dust', '#c:ender_pearls').id('craftoria:mekanism/crushing/ender_dust');
