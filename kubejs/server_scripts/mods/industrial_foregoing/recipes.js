ServerEvents.recipes(e => {
  ...
  foregoing.fluidExtraction(
    '5x integrateddynamics:menril_resin',
  ...
  foregoing.oreLaserDrilling('minecraft:ancient_debris', 'industrialforegoing:brown_laser_lens')
    .dimensionRarity(['minecraft:the_nether', 'jamd:nether'], 1, 1, 20).id('industrialforegoing:laser_drill_ore/ancient_debris');
});
