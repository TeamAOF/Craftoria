...
_Neoforge_ 21.1.216 | _[Mod Updates](https://github.com/TeamAOF/Craftoria/blob/main/changelogs/changelog_mods_2.0.0.md)_ | _[Modlist](https://github.com/TeamAOF/Craftoria/blob/main/changelogs/modlist_2.0.0.md)_
...
* Added "Growth Chamber" machine, used for growing small plants `Phantom`
...
* Improvements to how the server is setup **(Yoosk)**
...
_NeoForge Loader 21.0.16_ | _[Mod Updates](https://github.com/TeamAOF/Craftoria/blob/main/changelogs/changelog_mods_0.0.2.md)_ | _[Modlist](https://github.com/TeamAOF/Craftoria/blob/main/changelogs/modlist_0.0.2.md)_
...
* Fixed an issue with crashing whenever hovering trim tooltips **(AK)**
* Fixed resourcepacks not loading as enabled by default **(AK)**
---
